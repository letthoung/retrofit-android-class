...
object AllRecipes {
    var list: List<RecipeData> = mutableListOf()
        ...
        RecipeData(
            ...
            "We chose the moderately expensive boneless strip steak for its big, beefy flavor.",
            "INSTRUCTIONS\n" +
                    "\n" +
                    "1\n" +
        ...
        RecipeData(
            "Hamburgers",
            "Get Hamburgers Recipe from Food Network",
            "Directions:\n" +
                    "Step 1\n" +
